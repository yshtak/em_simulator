...
require 'yaml'
require "#{DIRROOT}/agents/05_home_agent"
require "#{DIRROOT}/filter/05_particle_filter"
require "awesome_print"
require "#{DIRROOT}/config/simulation_data.rb"
#: 初期設定
include SimulationData
ha = HomeAgent.new({filter: 'pf',address:'nagoya', midnight_strategy: false})
#ha = HomeAgent.new({filter: 'none',address:'nagoya', midnight_strategy: false})
